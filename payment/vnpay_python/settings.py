...
VNPAY_TMN_CODE = 'YZ0PEJUW'  # Website ID in VNPAY System, get from config
VNPAY_HASH_SECRET_KEY = 'QSUEVVMOURVYGVAOFAQEQSVFGSELYPMT'  # Secret key for create checksum,get from config
